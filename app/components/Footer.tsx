        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div className="space-y-4">
            <Link href="/" className="text-xl font-bold text-white">
              <span className="text-blue-300">MLB </span> FanFeed
            </Link>
            <p className="text-gray-400">
              Your ultimate destination for MLB highlights, stats, and predictions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["highlights", "stats", "predictions"].map((item) => (
                <li key={item}>
                  <Link href={`/${item}`} className="text-gray-400 hover:text-blue-400">
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              {[ 
                ...
                <a key={index} href={href} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400">
          ...
          <p>© {new Date().getFullYear()} MLB FanFeed. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
